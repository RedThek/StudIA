...
public class Salle {
    ...
    private String identifiant;         // Code de la salle (ex: "A101")
     ...
     */
    public Salle(String identifiant, String nom, String typeSalle,
    ...
    public String toString() {
        return String.format("SALLE | [%s] %s | %s | Capacité: %d élèves | %s | %s | Proj: %s | TBI: %s",
                identifiant, nom, typeSalle, capaciteMax, getEmplacement(),
